...
Quantifica il grado in cui il sistema risponde alle azioni delle utente, ovvero se le azioni permesse dal sistema coincidono con le intenzioni dell'utente.
...
L'\bld{affordance} è la proprietà di un oggetto di influenzare visivamente il modo in cui viene usato: riduce il golfo dell'esecuzione.
...
È l'efficacia, efficienza, e la soddisfazione con cui gli utenti reggiungono determinati obiettivi in determinati ambienti d'uso.
...
Un aspetto importante della misurazione dell'usabilità è \bld{quando} questa viene misurata (\itc{Al primo utlizzo? Quando un utemte è diventato esperto?})
