...
\begin{enumerate}
    \item \textbf{Comprendere e specificare il contesto d'uso}
          \begin{itemize}
    ...
    \item \textbf{Specificare i requisiti degli utenti e dell'organizzazione}
          \begin{itemize}
    ...
    \item \textbf{Produrre soluzioni di progetto}
          \begin{itemize}
    ...
    \item \textbf{Valutare il progetto rispetto ai requisiti}
          \begin{itemize}
