...
Quando guardiamo qualcosa, lo sguardo si fissa su un determinato punto (fissazione), per poi spostartsi su un altro punto (saccade); durante il movimento l'occhio è cieco. In media l'occhio esegue \itc{tre-quattro fissazioni al secondo}.
...
È un tracciato bidimensionale che compiono gli occhi durante l'esplorazione di una scena; studiando gli scanpath ad esempio su una pagina web si può capire i punti di interesse visivo maggiore per un utente, e il percorso che fanno i suoi occhi durante la navigazione.
